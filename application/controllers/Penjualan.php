...
class Penjualan extends CI_Controller
{
    ...
    public function create()
    {
        $data = array(
            ...
            'no_trans' => $this->No_urut->buat_kode_jual(),
            'id_sampah' => set_value('id_sampah'),
            'kode_sampah' => set_value('kode_sampah'),
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'kode_sampah' => $this->input->post('kode_sampah', TRUE),
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'kode_sampah' => set_value('kode_sampah', $row->kode_sampah),
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('kode_sampah', 'kode sampah', 'trim');
        $this->form_validation->set_rules('no_trans', 'no trans', 'trim');

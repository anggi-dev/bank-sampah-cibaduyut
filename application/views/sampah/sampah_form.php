<form action="<?php echo $action; ?>" method="post">
    <div class="form-group">
        <label for="varchar">Kode Sampah <?php echo form_error('kode_sampah') ?></label>
        <input type="text" class="form-control" name="kode_sampah" id="kode_sampah" placeholder="Kode Sampah" value="<?php echo $kode_sampah; ?>" />
    </div>
    <div class="form-group">

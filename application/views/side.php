  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php } elseif ($this->session->userdata('level') == 'operator') { ?>
        ...
        <li><a href="pembelian"><i class="fa fa-circle-o"></i> <span>Pembelian Sampah</span></a></li>
      ...
      <li><a href="https://github.com/angginuraziz/Petunjuk_Penggunaan_Bank_Sampah"><i class="fa fa-circle-o text-aqua"></i> <span>Bantuan</span></a></li>
    </ul>

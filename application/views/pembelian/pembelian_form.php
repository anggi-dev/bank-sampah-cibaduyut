<form action="<?php echo $aksi = ($this->uri->segment(3) == 'tabungan') ? $action . '/tabungan' : $action; ?>" method="post">
    ...
    <div class="form-group">
        <label for="int">Pilih Nasabah* <?php echo form_error('id_anggota') ?></label>
        ...
        <select class="form-control select2" name="id_anggota" style="width: 100%;">
            ...
            ?>
                <option value="<?php echo $row->id_anggota ?>"><?php echo $row->rekening_nasabah . '-' . $row->nama_anggota ?></option>
            <?php } ?>

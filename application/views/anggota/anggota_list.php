<div class="row" style="margin-bottom: 10px">
    <div class="col-md-4">
        ...
        <!-- Cetak Laporan -->
        <?php echo anchor(site_url('app/lap_nasabah'), 'Cetak Data Nasabah', 'class="btn btn-warning"'); ?>
        <!-- Download XLS --> <br><br>
        <?php echo anchor(site_url('export'), 'Export Data', 'class="btn btn-success"'); ?>
...
<table class="table table-bordered" style="margin-bottom: 10px">
    <tr>
        ...
        <tr>
            ...
            <td class="hidden"><?php echo $anggota->id_anggota ?></td>
            <td><?php echo $anggota->rekening_nasabah ?></td>
            ...
            <td style="text-align:center" width="200px">
                ...
                echo ' | ';
                echo anchor(site_url('anggota/delete/' . $anggota->id_anggota), '<span class="label label-danger">Hapus</span>', 'onclick="javasciprt: return confirm(\'Apakah anda yakin ?\')"');
                ?>
            </td>
        </tr>
    <?php

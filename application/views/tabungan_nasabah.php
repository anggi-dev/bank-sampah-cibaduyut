    ...
    <table class="table table-bordered">
        ...
        ?>
            <tr>
                ...
                <td><?php echo  $rw->id_anggota . '-' . ambil_field_tabel('anggota', 'id_anggota', $rw->id_anggota, 'nama_anggota') ?></td>
                <td><?php echo number_format($rw->jumlah);
                    $total_penarikan = $total_penarikan + $rw->jumlah; ?></td>
            </tr>
        <?php $no++;
        } ?>
        <tr>
